...
mix_spectrogram_button = tk.Button(button_frame, text="ShowSpectrogram", command=lambda: spectrogram(0))
...
separate_button = tk.Button(separate_frame, text="SeparateAudio", command=separate_mix, state="disabled")
